...
func (cm *Cmd) printHelpMessage() {
	...
	fmt.Println("[Usage]")
	fmt.Println("")
	fmt.Println("    mdpi [device] [plug] [plug's params(optional)]")
	fmt.Println()
	fmt.Println("    [exp]")
	fmt.Println("          mdpi en0 redis          Capture redis packet")
	fmt.Println("          mdpi en0 mysql -p 3306  Capture mysql packet")
	fmt.Println()
	fmt.Println("    mdpi --[commend]")
	...
	fmt.Println("    [exp]")
	fmt.Println("         mdpi --list \"show all plug-in\"")
	fmt.Println()
	fmt.Println("==================================================================================")
	cm.printDevice()
	fmt.Println("==================================================================================")
